...
namespace _7_lab_1_level
{
    ...
    {
        private static int normativeCountStoBeg = 0; 
        ...
        public static void PrintNormativeCount()  
        {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            PetsotBeg.PrintNormativeCount();
            StoBeg.PrintNormativeCount();
